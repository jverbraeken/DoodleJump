...
public class PauseScreenTest {
    ...
    public void init() throws Exception {
        ...
        when(spriteFactory.getSprite(IRes.Sprites.resume)).thenReturn(sprite);
        when(spriteFactory.getSprite(IRes.Sprites.achievement)).thenReturn(sprite);
        when(spriteFactory.getPowerupSprite(anyObject(), anyInt())).thenReturn(sprite);
        when(spriteFactory.getSprite(IRes.Sprites.scoreBar)).thenReturn(sprite);
