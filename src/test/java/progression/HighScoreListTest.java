...
public class HighScoreListTest {
    ...
    public void testInitHighScores1() throws FileNotFoundException {
        when(fileSystem.readProjectFile(constants.getHighScoresFilePath())).thenReturn(INIT_FILE_CONTENT_1);
    ...
    public void testInitHighScores2() throws FileNotFoundException {
        when(fileSystem.readProjectFile(constants.getHighScoresFilePath())).thenReturn(INIT_FILE_CONTENT_2);
        highScores.initHighScores();
    ...
    public void testGetList_empty() {
        List<HighScore> actual = highScores.getList();
